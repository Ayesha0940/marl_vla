...
try:
    ...
    sys.exit(1)
cfg.experiment.name = 'diffusion_square'
...
cfg.train.output_dir = os.path.join(PROJECT_ROOT, 'checkpoints/diffusion_square/')
...
# Observation modalities for Square task
...
config_file = os.path.join(config_dir, 'diffusion_policy_square.json')
