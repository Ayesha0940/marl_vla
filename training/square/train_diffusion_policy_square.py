#!/usr/bin/env python
"""
Generic training script for diffusion policy on square task using robomimic.
Usage: python training/square/train_diffusion_policy_square.py
"""
...
def main():
    ...
    config_file = os.path.join(PROJECT_ROOT, 'configs/diffusion_policy_square.json')
    if not os.path.exists(config_file):
        print("Generating diffusion policy config file...")
        gen_config_script = os.path.join(TRAINING_DIR, 'gen_config_diffusion_policy_square.py')
