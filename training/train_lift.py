#!/usr/bin/env python
"""
Generic training script for lift task that works across different machines and directories.
Usage: python train_lift.py
"""
...
def main():
    ...
    config_file = os.path.join(PROJECT_ROOT, 'configs/bc_rnn_lift.json')
    if not os.path.exists(config_file):
        print("Generating config file...")
        gen_config_script = os.path.join(TRAINING_DIR, 'gen_config_lift.py')
