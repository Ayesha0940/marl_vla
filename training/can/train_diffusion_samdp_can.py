#!/usr/bin/env python3
"""
SA-MDP UNet diffusion policy trainer for Robomimic Can.

Identical to train_unet_diffusion_can.py except the loss adds an observation-
...
Usage:
    ...
    python training/can/train_diffusion_samdp_can.py

    # kappa sweep
    python training/can/train_diffusion_samdp_can.py --kappa 0.3 --output_dir checkpoints/can_samdp_k03
    python training/can/train_diffusion_samdp_can.py --kappa 1.0 --output_dir checkpoints/can_samdp_k10
    python training/can/train_diffusion_samdp_can.py --kappa 3.0 --output_dir checkpoints/can_samdp_k30
"""
...
def default_config() -> dict:
    return {
        ...
        "train": {
            ...
            "output_dir":  os.path.join(PROJECT_ROOT, "checkpoints/can_samdp_unet"),
            "num_epochs":  4500,
            "batch_size":  256,
            "num_workers": 2,
            "log_freq":    10,
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="SA-MDP UNet diffusion policy trainer — Can")
