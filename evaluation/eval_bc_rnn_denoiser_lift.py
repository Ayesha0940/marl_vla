#!/usr/bin/env python3
"""
Evaluate BC RNN policy on the Lift task with optional action and joint denoisers.
...
Usage:
    python evaluation/eval_bc_rnn_denoiser_lift.py \\
        --bc_rnn_checkpoint checkpoints/bc_rnn_lift/.../model_epoch_600.pth \\
        --action_denoiser   diffusion_models/action_a0_lift.pt \\
        --joint_denoiser    diffusion_models/joint_a0_lift.pt \\
        --alpha_s 0.0 0.02 0.05 \\
        --alpha_a 0.0 0.3 \\
        --t_start 5 10 \\
        --n_rollouts 30 \\
        --output_csv results/lift/bc_rnn_denoiser/bc_rnn_a0_results.csv
"""
...
_GRIPPER_ACTION_DIM = 6   # index of gripper command in 7-dim Lift action
_LIFT_Z_THRESH      = 0.85
...
def parse_args():
    ...
    p.add_argument("--output_csv", type=str,
                   default="results/lift/bc_rnn_denoiser/results.csv")
